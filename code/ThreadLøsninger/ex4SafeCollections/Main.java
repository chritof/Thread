...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        //hvis du kjører koden mange ganger vi du av og til merke at
        //listen ikke blir fullstedig. ArrayList -> mutalbe
        ...
        //dette er et eksempel som viser at ArrayList ikke er immutable.
        //tråder skriver kode til det samme kritiske område uten synchronized
        ...
        System.out.println("Størrelse på list: " + list2.size() + ", men forventet resultat er 2000000");
