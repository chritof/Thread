...
public class Ball extends JPanel {
    ...
    public Ball(Color farge, int bane) {
        ...
        this.setLocation(0, bane * 2 * Constants.BALL_DIAMETER);
    }
    ...
    private boolean erIMaal(int x) {
        return x + fart < 0 && fart < 0 || x + Constants.BALL_DIAMETER + fart > tegneflaten.getWidth() && fart > 0;
    }
    ...
    private int randomVxVy() {
        return (int) Math.round((Math.random() * Constants.MAX_VX_VY) + 1);
    }
}
